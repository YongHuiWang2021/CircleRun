...
namespace XD.Core
{
    public class RigidbodyUtil
    {
        ...
        public static void SetMass(Rigidbody rigidbody,float mass)
        {
            if (rigidbody != null)
            {
                rigidbody.mass = mass;
        ...
        public static void SetDrag(Rigidbody rigidbody,float drag)
        {
            if (rigidbody != null)
            {
                rigidbody.drag = drag;
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetAngularDrag(Rigidbody rigidbody,float angularDrag)
        {
            if (rigidbody != null)
            {
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetUseGravity(Rigidbody rigidbody,bool useGravity)
        {
            if (rigidbody != null)
            {
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetKinematic(Rigidbody rigidbody,bool kinematic)
        {
            if (rigidbody != null)
            {
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetInterpolate(Rigidbody rigidbody,RigidbodyInterpolation interpolation)
        {
            if (rigidbody != null)
            {
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetCollisionDetection(Rigidbody rigidbody,CollisionDetectionMode Collision)
        {
            if (rigidbody != null)
            {
        ...
        /// </summary>
        /// <param name="rigidbody"></param>
        public static void SetConstraints(Rigidbody rigidbody,RigidbodyConstraints constraints)
        {
            if (rigidbody != null)
            {
